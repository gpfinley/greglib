 ...
 */
@Deprecated
public class PhraseEmbeddings implements Iterable<Phrase>, Serializable {
    ...
    public PhraseEmbeddings(int dimensionality) {
    ...
    /**
     * Remove all greglib.embeddings other than those provided in a set of Phrases
     * @param toKeep
     */
